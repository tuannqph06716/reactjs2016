...
const Categories = (props)=>{
    ...
    useEffect(() => {
        const fetchloai= async()=>{
           const res= await Axios.get('https://5ea1c7f7b9f5ca00166c2226.mockapi.io/conga/sanpham?id_loai='+key)
              setLoai(res.data);
            }
            fetchloai();
          },[]);
                ...
                <div className="col-12">
                  <div className="breadcrumb-wrap text-center">
                    <nav aria-label="breadcrumb">
                      <h1 className="breadcrumb-title">CATEGORIES</h1>
                      <ul className="breadcrumb">
                          {cay.map(ma=>{
                              if(ma.id==key){
                                  return (
                                <li className="breadcrumb-item"><a href="index.html">{ma.name}</a></li>
                                  )}})}
                      </ul>
                    </nav>
                  </div>
